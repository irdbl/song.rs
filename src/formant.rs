...
/// The 8-vowel alphabet, designed for dual-F0 (208/277 Hz) discrimination.
///
...
pub const VOWELS: [VowelParams; NUM_VOWELS] = [
    VowelParams { f1: 485.0, f2: 1074.0 }, // 0 — mid-F1
    VowelParams { f1: 485.0, f2: 2009.5 }, // 1 — mid-F1
    VowelParams { f1: 485.0, f2: 2494.5 }, // 2 — mid-F1
    VowelParams { f1: 589.0, f2: 1559.0 }, // 3 — high-F1
    VowelParams { f1: 727.5, f2: 1074.0 }, // 4 — high-F1
    VowelParams { f1: 727.5, f2: 2009.5 }, // 5 — high-F1
    VowelParams { f1: 831.5, f2: 1559.0 }, // 6 — high-F1
    VowelParams { f1: 831.5, f2: 2494.5 }, // 7 — high-F1
];

/// Start preamble: vowel0@low, vowel7@low, repeat.
/// Vowels 0 and 7 have maximum F1+F2 separation (distance 7.90).
